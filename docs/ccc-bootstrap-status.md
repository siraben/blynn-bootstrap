...
3. Continue growing ADT declarations, pattern parsing, and pattern compilation
   ...
   wildcard, multi-declaration, and three-arm matches but not recursive/nested
   decision trees yet.
