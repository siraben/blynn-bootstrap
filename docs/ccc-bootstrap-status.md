...
| 3 | `mlc-seed.m2` | `mlc/mlc-seed.c`; `tests/mlc/ok.ml`; flake target `mlc-seed.m2`; M2-built compiler emits `.mzbc` and `mzvm-seed` runs it to `OK` | partial: fixture compiler only |
