...
The current stage-03 pattern slice stores match arms as a recursive case-list
AST and parses constructor `match`
...
non-final default arms, and lowers branches to `GETTAG`
