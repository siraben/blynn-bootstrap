...
prims = let
  ...
  in map (second (first $ Qual [])) $
    ...
    , ("doubleAdd", (arr (TC "Double") (arr (TC "Double") (TC "Double")), bin "FADD"))
    , ("doubleSub", (arr (TC "Double") (arr (TC "Double") (TC "Double")), bin "FSUB"))
    , ("doubleMul", (arr (TC "Double") (arr (TC "Double") (TC "Double")), bin "FMUL"))
    , ("doubleDiv", (arr (TC "Double") (arr (TC "Double") (TC "Double")), bin "FDIV"))
    ...
    , ("wordFromUU", (arr (TC "Word64") (TC "Word"), A (ro "T") (ro "UULO")))
    , ("uuPad", (arr (TC "Word") (TC "Word64"), A (ro "T") (ro "UUPAD")))
    , ("uuEq", (arr (TC "Word64") (arr (TC "Word64") (TC "Bool")), bin "UUEQ"))
    , ("uuLE", (arr (TC "Word64") (arr (TC "Word64") (TC "Bool")), bin "UULE"))
    ...
    , ("wordShl", (arr (TC "Word") $ arr (TC "Int") (TC "Word"), bin "SHL"))
    , ("wordShr", (arr (TC "Word") $ arr (TC "Int") (TC "Word"), bin "U_SHR"))
    , ("uuShl", (arr (TC "Word64") $ arr (TC "Int") (TC "Word64"), bin "UUSHL"))
    , ("uuShr", (arr (TC "Word64") $ arr (TC "Int") (TC "Word64"), bin "UUSHR"))
    ]
...
unaliasType als = go [] where
  go spine = \case
    ...
    TC s | Just (vs, ty) <- mlookup s als -> unaliasType als $ tySub (zip vs spine) ty
    t -> foldl TAp t spine
