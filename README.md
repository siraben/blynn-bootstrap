...
The mini-ML toolchain also exposes `debug_byte`, `debug_string`, `debug_int`,
...
PRECISELY_UP=$PWD/build/blynn-precisely/bin/precisely_up HCC_BLYNN_OBJECTS_DIR=$PWD/build/hcc-blynn-objs scripts/hcc-blynn-c.sh
